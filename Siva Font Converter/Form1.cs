...
namespace WindowsFormsApplication1
{
    public partial class frm : Form
    {
        ...
        string[] oldshree = {"'fb", "'b6", "S", "c", "u", "J", "'a6", "'b4", "x", "'c4", "'f3", "'c4V", "U",
                                    "@", "@\\'b0", "r", "'e9", "'e3", "'a8", "N@", "'c7@", "'bc@", "N@\\'b0", "'c7@\\'b0", "N@V", "'f7",
                                    "'ef", "'ef\\'b0", "'d3", "'f2", "'80", "'81", "N\\'ef", "'c7\\'ef", "'bc\\'ef", "N\\'ef\\'b0", "'c7\\'ef\\'b0", "N\\'efV", "_",
                                    "'dd", "'dd\\'b0", "'d8", "'e1", "'b8", "~", "N\\'dd", "'c7\\'dd", "'bc\\'dd", "N\\'dd\\'b0", "'c7\\'dd\\'b0", "N\\'ddV", "'d9",
                                    "Q", "Q\\'b0", "'af", "<", "'82", "'83", "NQ", "'c7Q", "'bcQ", "NQ\\'b0", "'c7Q\\'b0", "NQV", "k",
                                    "v", "v\\'b0", "'e5", "'fc", "q", "'ce", "Nv", "'c7v", "'bcv", "Nv\\'b0", "'c7v\\'b0", "NvV", "'cb",
                                    "}", "}\\'b0", "'df", "`", "B", "'ae\\'a3", "N\\}", "'c7\\}", "'bc\\}", "N\\}\\'b0", "'c7\\}\\'b0", "N\\}V", "'d2",
                                    "P", "P\\'b0", "i", "X", "'a2", "l", "NP", "'c7P", "'bcP", "NP\\'b0", "'c7P\\'b0", "NPV", "'ab",
                                    "'c0", "'c0\\'b0", "a", "'d5", "O", "'bd", "N\\'c0", "'c7\\'c0", "'bc\\'c0", "N\\'c0\\'b0", "'c7\\'c0\\'b0", "N\\'c0V", "'da",
                                    "'e2", "'e2\\'b0", "'aa", "y", "'f4", "'f1", "N\\'e2", "'c7\\'e2", "'bc\\'e2", "N\\'e2\\'b0", "'c7\\'e2\\'b0", "N\\'e2V", "g",
                                    "'a9", "'a9\\'b0", "d", "p", "'c2", "'c9", "N\\'a9", "'c7\\'a9", "'bc\\'a9", "N\\'a9\\'b0", "'c7\\'a9\\'b0", "N\\'a9V", "'ee",
                                    "'cc", "'cc\\'b0", "'c3", "M", "'b3", "w", "N\\'cc", "'c7\\'cc", "'bc\\'cc", "N\\'cc\\'b0", "'c7\\'cc\\'b0", "N\\'ccV", "'db",
                                    "'bb", "'bb\\'b0", "'a4", "|", "'de", "'a7", "N\\'bb", "'c7\\'bb", "'bc\\'bb", "N\\'bb\\'b0", "'c7\\'bb\\'b0", "N\\'bbV", "'f0",
                                    "'b9", "'b9\\'b0", "'b7", "'d4", "t", "\\", "N\\'b9", "'c7\\'b9", "'bc\\'b9", "N\\'b9\\'b0", "'c7\\'b9\\'b0", "N\\'b9V", "Y",
                                    "z", "z\\'b0", "T", "'cf", "s", "'d7", "Nz", "'c7z", "'bcz", "Nz\\'b0", "'c7z\\'b0", "NzV", "b",
                                    "'c6", "'c6\\'b0", "{", "'f9", "[", "m", "N\\'c6", "'c7\\'c6", "'bc\\'c6", "N\\'c6\\'b0", "'c7\\'c6\\'b0", "N\\'c6V", "'dc",
                                    "V", "V\\'b0", "'c8", "'b2", "^", "o", "NV", "'c7V", "'bcV", "NV\\'b0", "'c7V\\'b0", "NVV", "'d6",
                                    "G", "G\\'b0", "'ba", "'ed", "'b5", "'f5", "NG", "'c7G", "'bcG", "NG\\'b0", "'c7G\\'b0", "NGV", "n",
                                    "L", "L\\'b0", ">", "'d0", "'b1", "'eb", "NL", "'c7L", "'bcL", "NL\\'b0", "'c7L\\'b0", "NLV", "'ea",

                                    "Z", "Z\\'b0", "'fe", "K", "ZH", "Z\\'be", "NZ", "'c7Z", "'bcZ", "NZ\\'b0", "'c7Z\\'b0", "NZV", "'bf",
                                    "E", "E\\'b0", "'f6", "I", "EH", "E\\'be", "NE", "'c7E", "'bcE", "NE\\'b0", "'c7E\\'b0", "NEV", "e",
                                    "j", "j\\'b0", "f", "'f8", "jH", "j\\'be", "Nj", "'c7j", "'bcj", "Nj\\'b0", "'c7j\\'b0", "NjV", "'c1",
                                    "R", "R\\'b0", "'e6", "h", "RH", "R\\'be", "NR", "'c7R", "'bcR", "NR\\'b0", "'c7R\\'b0", "NRV", "'ac",
                                    "'e8", "'e8\\'b0", "C", "F", "'e8H", "'e8\\'be", "N\\'e8", "'c7\\'e8", "'bc\\'e8", "N\\'e8\\'b0", "'c7\\'e8\\'b0", "N\\'e8V", "'e4",
                                    "'e7"
                             };
        ...
        string[] tm = {"A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "J\\'fc", "@",
                            "L", "L\\'f4", "'a1", "'b8", "'cf", "'e1", "'f9L", "'faL", "'fbL", "'f9L\\'f4", "'faL\\'f4", "'f9L\\'fc", "d", 
                            "M", "M\\'f4", "'a2", "'b9", "'d0", "'e2", "'f9M", "'faM", "'fbM", "'f9M\\'f4", "'faM\\'f4", "'f9M\\'fc", "e", 
                            "N", "N\\'f4", "'a3", "'ba", "'d1", "'e3", "'f9N", "'faN", "'fbN", "'f9N\\'f4", "'faN\\'f4", "'f9N\\'fc", "f", 
                            "O", "O\\'f4", "'a4", "'bb", "'d2", "'e4", "'f9O", "'faO", "'fbO", "'f9O\\'f4", "'faO\\'f4", "'f9O\\'fc", "g", 
                            "P", "P\\'f4", "'a5", "'bc", "'d3", "'e5", "'f9P", "'faP", "'fbP", "'f9P\\'f4", "'faP\\'f4", "'f9P\\'fc", "h", 
                            "Q", "Q\\'f4", "'a6", "'bd", "'d4", "'e6", "'f9Q", "'faQ", "'fbQ", "'f9Q\\'f4", "'faQ\\'f4", "'f9Q\\'fc", "i", 
                            "R", "R\\'f4", "'a7", "'be", "'d5", "'e7", "'f9R", "'faR", "'fbR", "'f9R\\'f4", "'faR\\'f4", "'f9R\\'fc", "j", 
                            "S", "S\\'f4", "'a8", "'bf", "'d6", "'e8", "'f9S", "'faS", "'fbS", "'f9S\\'f4", "'faS\\'f4", "'f9S\\'fc", "k", 
                            "T", "T\\'f4", "'a9", "'c0", "'d7", "'e9", "'f9T", "'faT", "'fbT", "'f9T\\'f4", "'faT\\'f4", "'f9T\\'fc", "l", 
                            "U", "U\\'f4", "'aa", "'c1", "'d8", "'ea", "'f9U", "'faU", "'fbU", "'f9U\\'f4", "'faU\\'f4", "'f9U\\'fc", "m", 
                            "V", "V\\'f4", "'ab", "'c2", "'d9", "'eb", "'f9V", "'faV", "'fbV", "'f9V\\'f4", "'faV\\'f4", "'f9V\\'fc", "n", 
                            "W", "W\\'f4", "'ac", "'c3", "'da", "'ec", "'f9W", "'faW", "'fbW", "'f9W\\'f4", "'faW\\'f4", "'f9W\\'fc", "o", 
                            "X", "X\\'f4", "'ad", "'c4", "'db", "'ed", "'f9X", "'faX", "'fbX", "'f9X\\'f4", "'faX\\'f4", "'f9X\\'fc", "p", 
                            "Y", "Y\\'f4", "'ae", "'c5", "'dc", "'ee", "'f9Y", "'faY", "'fbY", "'f9Y\\'f4", "'faY\\'f4", "'f9Y\\'fc", "q", 
                            "Z", "Z\\'f4", "'af", "'c6", "'dd", "'ef", "'f9Z", "'faZ", "'fbZ", "'f9Z\\'f4", "'faZ\\'f4", "'f9Z\\'fc", "r", 
                            "[", "[\\'f4", "'b0", "'c7", "'de", "'f0", "'f9[", "'fa[", "'fb[", "'f9[\\'f4", "'fa[\\'f4", "'f9[\\'fc", "s", 
                            "\\\\", "\\\\'f4", "'b1", "'c8", "'df", "'f1", "'f9\\", "'fa\\", "'fb\\", "'f9\\\\'f4", "'fa\\\\'f4", "'f9\\\\'fc", "t", 
                            "]", "]\\'f4", "'b2", "'c9", "'e0", "'f2", "'f9]", "'fa]", "'fb]", "'f9]\\'f4", "'fa]\\'f4", "'f9]\\'fc", "u", 

                            "^", "^\\'f4", "'b3", "'ca", "^\\'f7", "^\\'f8", "'f9^", "'fa^", "'fb^", "'f9^\\'f4", "'fa^\\'f4", "'f9^\\'fc", "v", 
                            "`", "`\\'f4", "'b5", "'cc", "`\\'f7", "`\\'f8", "'f9`", "'fa`", "'fb`", "'f9`\\'f4", "'fa`\\'f4", "'f9`\\'fc", "x", 
                            "_", "_\\'f4", "'b4", "'cb", "_\\'f7", "_\\'f8", "'f9_", "'fa_", "'fb_", "'f9_\\'f4", "'fa_\\'f4", "'f9_\\'fc", "w", 
                            "a", "a\\'f4", "'b6", "'cd", "a\\'f7", "a\\'f8", "'f9a", "'faa", "'fba", "'f9a\\'f4", "'faa\\'f4", "'f9a\\'fc", "y", 
                            "b", "b\\'f4", "'b7", "'ce", "b\\'f7", "b\\'f8", "'f9b", "'fab", "'fbb", "'f9b\\'f4", "'fab\\'f4", "'f9b\\'fc", "z", 
                            "c"
                            };
        ...
        public void Convert(string font)
        {
            ...
            if (fonttable.IndexOf(font) < 0 & fonttable.IndexOf(font.ToUpper()) < 0 & fonttable.IndexOf("SUNDARAM") < 0 &
                ...
                fonttable.IndexOf("SunTommy") < 0 & fonttable.IndexOf("SHREE") < 0)
            {
                sr.Close();
                sw.Close();
                goto NoMatch;
            ...
            while (pos < len)
            {
                ...
                else if (fontname.IndexOf("SHREE") == 0 | fontname.IndexOf("SURYA") == 0)
                {
                    st = st.Replace(fontname, "SHREE800");
                    fontname = "SHREE800";
                }

                if (fontname.IndexOf(font) == 0 | fontname.IndexOf(font.ToUpper()) == 0 | fontname.IndexOf("SHREE") == 0)
                {
                ...
                switch (ftype)
                {
                    ...
                    case 'T':
                        ...
                        while (num < content.Length)
                        {
                            ...
                            if (ch == '\\')
                            {
                                string oshree = "abcdefghijklmnopqrstuvwxyz\'{}";
                                next = content[num + 1];
                                if (font == "OLDSHREE" & oshree.IndexOf(next) < 0)
                                {
                                    sw.Write("\\u2994?\\u3010?");
                                    num += 1;
                                }
                                ...
                                else if (next == '-' & (font == "SVC" | font == "JF" | font == "TM"))
                                {
                                    sw.Write("\\u2994?\\u3007?");
                                    num += 2;
                                }
                                ...
                                else
                                {
                                    ...
                                    switch (font)
                                    {
                                        ...
                                        case "OLDSHREE":
                                            ...
                                            for (n = 0; n <= 312; n++)
                                                if (tletter == (oldshree[n])) break;

                                            if (n < 312 & n % 13 == 0 & (ottu == "'b0" | ottu == "'be"))
                                            {
                                                tletter = content.Substring(num + 1, 7);
                                                num += 8;
                                            }
                                        ...
                                        case "TM":
                                            ...
                                            else
                                            {
                                                ...
                                                switch (tletter)
                                                {
                                                    ...
                                                    case "'f9":
                                                        ...
                                                        if (content.Substring(num + 6, 3) == "'f4" | content.Substring(num + 6, 3) == "'fc")
                                                        {
                                                            tletter = content.Substring(num + 1, 8);
                                                            num += 9;
                                                        }
                                            ...
                                            else if (tletter == "'92" | tletter == "'93" | tletter == "'94" | tletter == "'a0" | tletter == "'85")
                                            {
                                                uletter = " ";
                                            }
                                            else
                            ...
                            else
                            {
                                ...
                                switch (font)
                                {
                                    ...
                                    case "OLDSHREE":
                                        ...
                                        if (ch == 'N')
                                        {
                                            if (content.Substring(num + 3, 3) == "'b0")
                                            {
                                                tletter = content.Substring(num, 6);
                                                num += 5;
                                            }
                                            /*else if (content.Substring(num + 4, 3) == "'b0")
                                            {
                                                tletter = content.Substring(num, 7);
                                                num += 6;
                                            }*/
                                            else if (content.Substring(num + 1, 2) == "\\'" & content.Substring(num + 6, 3) == "'b0")
                                            {
                                                tletter = content.Substring(num, 9);
                                                num += 8;
                                            }
                                            else if (content.Substring(num + 1, 2) == "\\}")
                                            {
                                    ...
                                    case "TM":
                                        ...
                                        try
                                        {
                                            ottut = content.Substring(num + 2, 3);
                                        }
                                        catch
                                        {
                                        }

                                        if (ottut == "'f4" | ottut == "'f7" | ottut == "'f8" | ottut == "'fc")
                                        {
                                            tletter = content.Substring(num, 5);
                                            num += 4;
                                        }
        ...
        private void TmToUnicode_Click(object sender, EventArgs e)
        {
            Convert("TM");
        }

        private void OldshreeToUnicode_Click(object sender, EventArgs e)
        {
            Convert("Oldshree");
        }
